...
//
// Ported verbatim from PRIVATE/NTOS/BOOT/LIB/BLMEMORY.C (DOS CRLF + Ctrl-Z
// stripped). The original includes only "bldr.h"; we add "string.h" because the
// loader's RtlZeroMemory shim (portdecls.h) expands to memset(), prototyped
// there and defined in clib.c. This file owns BlLoaderBlock - the arcemul.c BSS
// placeholder was removed to avoid a duplicate symbol.
//
#include "bldr.h"
#include "string.h"

