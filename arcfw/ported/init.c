...

{
    ...
    if (Number == 0) {
        ...
        KiEmit("INIT: before MmInitializeMemoryLimits\n");
        ...
        KiEmit("INIT: before RtlInitNlsTables\n");
        RtlInitNlsTables(
        ...
        KiEmit("INIT: before HalInitSystem\n");
...
#endif
        KiEmit("INIT: before NtSystemPath sprintf\n");
        ...
        KiEmit("INIT: before module-list DbgLoadImageSymbols walk\n");
        ImageCount = 0;
        ...
        KiEmit("INIT: before LdrFindResource_U (bugcheck msgs)\n");
    ...
    if (Number == 0) {
        ...
        KiEmit("INIT: before CmGetSystemControlValues\n");
        ...
        KiEmit("INIT: before ExInitSystem\n");
        if (!ExInitSystem()) {
        ...
        KiEmit("INIT: before ExBurnMemory\n");
        ExBurnMemory(LoaderBlock);

        KiEmit("INIT: before MmInitSystem\n");
        ...
        *s++ = '\0';
        ...
        KiEmit("INIT: before version banner\n");
        HalDisplayString(s);
        ...
        KiEmit("INIT: before RtlInitializeHeapManager\n");
        ...
        KiEmit("INIT: before ObInitSystem\n");
        if (!ObInitSystem()) {
            KeBugCheck(OBJECT_INITIALIZATION_FAILED);
        }

        KiEmit("INIT: before SeInitSystem\n");
        if (!SeInitSystem()) {
            KeBugCheck(SECURITY_INITIALIZATION_FAILED);
        }

        KiEmit("INIT: before PsInitSystem\n");
        ...
        KiEmit("INIT: before ExComputeTickCountMultiplier (end P0)\n");
