...
for c in ke/kearm.c ke/initkr.c ke/ctxsw.c ke/timindex.c ke/clock.c ke/halirq.c ke/seh.c ke/mmuarm.c ke/exarm.c ke/exglobals.c ke/rtlarm.c ke/portstubs.c ../ported/wait.c ../ported/queueobj.c; do
